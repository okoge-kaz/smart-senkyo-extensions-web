...
export const MainContent: Function = (props: Props) => {
  ...
  const main_area: Function = (step: number):ReactElement => {
    switch(step){
      ...
      case 3:
        return <MainChoiceArea main_action_direction={["オプションを選択してください"]} main_button_elements={choose_option_button} onAddressSeparaterActed={props.onAddressSeparaterActed} address_separater_selected_flag={props.address_separater_selected_flag}/>
      case 4:
