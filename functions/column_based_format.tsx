...
export default function column_based_format(file_number: number, sheet_name: string, file_name: string, file_data: JSON, export_blobs: Blob[], export_blob_names: string[]){
  // args: file_number: ファイルナンバー（APIでは1シート1ファイルとしてJSONに処理されるため、総シート数の中で何番目かということになる）
  //       sheet_name:
  //       file_name:
  //       file_data:
  //       export_blobs: スマセン形式の列名として成形したEXCELファイルの格納先となるBlob[]
  //       export_blob_names: スマセン形式として成形したEXCELファイルのファイル名の格納先となるstring[]
  // return: void
  // 
